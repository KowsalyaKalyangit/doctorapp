...
import 'owners_detailscreen.dart';

class OwnerInputFields extends StatefulWidget {
  const OwnerInputFields({Key? key}) : super(key: key);

  @override
  State<OwnerInputFields> createState() => _OwnerInputFieldsState();
}

class _OwnerInputFieldsState extends State<OwnerInputFields> {
            ...
            Padding(
              ...
              child: ButtonIconButton(
                press: () {
                  ...
                  Get.to(const RegistrationClubScreen());
                },
