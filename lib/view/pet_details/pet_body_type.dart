...
class PetBodyType extends StatefulWidget {
  const PetBodyType({super.key});

  @override
  State<PetBodyType> createState() => _PetBodyTypeState();
}

class _PetBodyTypeState extends State<PetBodyType> {
  var energylevel = [
    'Lean and Toned',
    'Athletic and Strong',
